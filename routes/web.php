...
Route::post('/dashboard/classes', [DashboardController::class, 'store'])->middleware('auth')->name('dashboard.classes.store');
Route::get('/dashboard/bookings', [BookingsController::class, 'index'])->middleware('auth')->name('dashboard.bookings');
Route::get('/dashboard/bookings/{booking}', [BookingsController::class, 'show'])->middleware('auth');
Route::get('/dashboard/bookings/{booking}/history', [BookingsController::class, 'history'])->middleware('auth');
Route::put('/dashboard/bookings/{booking}', [BookingsController::class, 'update'])->middleware('auth');
Route::post('/dashboard/bookings/{booking}/cancel', [BookingsController::class, 'cancel'])->middleware('auth');
